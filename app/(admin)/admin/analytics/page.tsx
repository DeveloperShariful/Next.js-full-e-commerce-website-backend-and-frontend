...
import { AnalyticsHeader } from "@/app/(admin)/admin/analytics/_components/analytics-header";
import { SummaryCards } from "@/app/(admin)/admin/analytics/_components/summary-cards";
import { SalesChart } from "@/app/(admin)/admin/analytics/_components/sales-chart";
import { TopProducts } from "@/app/(admin)/admin/analytics/_components/top-products";
