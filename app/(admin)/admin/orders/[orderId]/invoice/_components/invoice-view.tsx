//app/admin/orders/[orderId]/invoice/_components/invoice-view.tsx
                            ...
                            <tbody className="divide-y divide-slate-100">
                                {order.items.map((item: any) => (
                                    <tr key={item.id}>
                                        ...
                                        <td className="py-4 text-right text-sm text-slate-600">{formatPrice(item.price)}</td>
                                        <td className="py-4 text-center text-sm text-slate-600">{item.quantity}</td>
                                        <td className="py-4 text-right text-sm font-bold text-slate-800">{formatPrice(item.total)}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
