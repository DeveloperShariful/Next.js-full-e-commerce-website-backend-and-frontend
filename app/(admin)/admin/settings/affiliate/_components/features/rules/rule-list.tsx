// File: app/(admin)/admin/settings/affiliate/_components/features/rules/rule-list.tsx
...
import { deleteRuleAction } from "@/app/actions/admin/settings/affiliate/mutations/manage-rules";
