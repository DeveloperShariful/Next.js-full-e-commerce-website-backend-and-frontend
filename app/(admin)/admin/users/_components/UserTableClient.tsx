//app/(admin)/admin/users/_components/UserTableClient.tsx
...
import { deleteUser, bulkDeleteUsers, bulkChangeRole, sendPasswordReset } from '@/app/actions/admin/users/user-actions';
import Pagination from '@/app/(admin)/admin/warranty-claims/_components/Pagination'; 
