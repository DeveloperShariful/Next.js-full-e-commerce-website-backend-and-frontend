...
export function DashboardView({ data }: DashboardViewProps) {
  ...
  const labels: Record<DataRange, string> = {
    today: "Today",
    yesterday: "Yesterday",
    week: "Last 7 Days",
    month: "Last 30 Days",
  ...
  return (
    <div className="font-sans text-[#3c434a] max-w-full">
      ...
      {/* 3. Store Performance (Business Pulse) */}
      <div className="mb-5">
      ...
      {/* 5. Recent Warranty Claims */}
      <div className="bg-white border border-[#c3c4c7] shadow-sm mt-6">
        <h2 className="px-4 py-2 border-b border-[#c3c4c7] text-[14px] font-semibold text-[#1d2327] bg-[#f6f7f7]">
