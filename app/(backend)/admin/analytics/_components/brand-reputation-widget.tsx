//app/(backend)/admin/analytics/_components/brand-reputation-widget.tsx

"use client";

import { useState } from "react";
import { ReviewSummary, BrandPerformanceMetric } from "@/app/actions/backend/analytics/types";
