//app/(backend)/admin/analytics/_components/customer-insights-widget.tsx

"use client";

import { CustomerDemographic, CustomerTypeBreakdown, TopCustomerMetric } from "@/app/actions/backend/analytics/types";
