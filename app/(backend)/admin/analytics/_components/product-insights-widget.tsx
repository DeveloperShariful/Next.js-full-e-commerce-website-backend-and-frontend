//app/(backend)/admin/analytics/_components/product-insights-widget.tsx

"use client";

import { useState } from "react";
import { TopProductMetric, InventoryHealthMetric, CategoryPerformanceMetric } from "@/app/actions/backend/analytics/types";
