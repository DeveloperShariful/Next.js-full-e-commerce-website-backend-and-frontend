//app/(backend)/admin/analytics/_components/traffic-conversion-widget.tsx

"use client";

import { ConversionFunnelStep, MostViewedProduct } from "@/app/actions/backend/analytics/types";
