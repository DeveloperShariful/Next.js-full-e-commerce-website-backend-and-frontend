// app/(backend)/admin/media/_components/media-library.tsx

"use client";

import { useState, useEffect, useTransition, useCallback } from "react";
import { getAllMedia, MediaItem } from "@/app/actions/backend/media/media-read";
import { bulkDeleteMedia } from "@/app/actions/backend/media/media-delete";
import { getFolderTree, deleteFolder } from "@/app/actions/backend/media/folder-actions";
import { moveMediaToFolder } from "@/app/actions/backend/media/media-move"; 
