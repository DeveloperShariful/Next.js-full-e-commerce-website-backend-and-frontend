        ...
        {isOpen && (
            <div className="p-3 space-y-4">
                ...
                <div className="space-y-1">
                    ...
                    <select
                        value={orderData.status === "PENDING" ? "UNPAID" : "PAID"} // Visual indication
                        disabled
                ...
                <div className="pt-3 border-t border-[#f0f0f1] flex justify-between items-center bg-[#f6f7f7] -mx-3 -mb-3 px-3 py-2 mt-4">
                    {/* ✅ FIXED: Type changed to prevent accidental form submissions if placed inside a form */}
                    <button 
                        type="button" 
                        onClick={(e) => { e.preventDefault(); handleCreateOrder(true); }} // Save as Draft
                        disabled={loading}
                    ...
                    <button 
                        type="button"
                        onClick={(e) => { e.preventDefault(); handleCreateOrder(false); }} // Create Order
                        disabled={loading}
