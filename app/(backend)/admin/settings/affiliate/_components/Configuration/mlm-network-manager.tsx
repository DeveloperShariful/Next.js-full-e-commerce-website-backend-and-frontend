// File: app/(backend)/admin/settings/affiliate/_components/Configuration/mlm-network-manager.tsx

"use client";

import { useState } from "react";
import { NetworkNode } from "@/app/actions/backend/settings/affiliate/types";
