// File: app/(backend)/admin/settings/affiliate/page.tsx

import { Suspense } from "react";
import { Loader2, AlertTriangle } from "lucide-react";
import AffiliateMainView from "./_components/affiliate-main-view";
import { db } from "@/lib/prisma";
import * as statsService from "@/app/actions/backend/settings/affiliate/_services/dashboard-service";
import * as accountService from "@/app/actions/backend/settings/affiliate/_services/account-service"; 
import * as payoutService from "@/app/actions/backend/settings/affiliate/_services/payout-service";
import * as configService from "@/app/actions/backend/settings/affiliate/_services/general-config-service";
import * as tierService from "@/app/actions/backend/settings/affiliate/_services/tier-service";
import * as marketingService from "@/app/actions/backend/settings/affiliate/_services/marketing-assets-service";
import * as ruleEngineService from "@/app/actions/backend/settings/affiliate/_services/commition-rule-service";
import * as engagementService from "@/app/actions/backend/settings/affiliate/_services/engagement-service";
import * as networkService from "@/app/actions/backend/settings/affiliate/_services/mlm-network-service";
import * as fraudService from "@/app/actions/backend/settings/affiliate/_services/fraud-service";
import * as trackingService from "@/app/actions/backend/settings/affiliate/_services/pixel-domain-service";
import * as productRateService from "@/app/actions/backend/settings/affiliate/_services/product-rate-service";
import * as kycService from "@/app/actions/backend/settings/affiliate/_services/kyc-service";
import * as ledgerService from "@/app/actions/backend/settings/affiliate/_services/ledger-service";
import * as analyticsService from "@/app/actions/backend/settings/affiliate/_services/dashboard-service";
import * as groupService from "@/app/actions/backend/settings/affiliate/_services/group-service";
import * as couponTagService from "@/app/actions/backend/settings/affiliate/_services/coupon-tag-service";
import * as logService from "@/app/actions/backend/settings/affiliate/_services/log-service"; 
