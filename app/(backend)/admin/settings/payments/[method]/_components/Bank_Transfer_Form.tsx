...
import { BankTransferSchema } from "@/app/(backend)/admin/settings/payments/schemas"
import { updateBankTransferSettings } from "@/app/actions/backend/settings/payments/offline-payment-method"
import { z } from "zod"
...
export const Bank_Transfer_Form = ({ methodId, config, offlineConfig }: BankFormProps) => {
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Input {...field} value={field.value || ""} className="h-9 bg-white" />
                    </FormItem>
                  )}
                />
                <FormField
