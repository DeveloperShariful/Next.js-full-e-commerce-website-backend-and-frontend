...
import { Settings2, ArrowRight, RefreshCw, Loader2 } from "lucide-react"
import { toast } from "sonner"
import { useRouter } from "next/navigation"
import Link from "next/link"
import { togglePaymentMethodStatus, resetPaymentMethodsDB } from "@/app/actions/backend/settings/payments/payments-dashboard"
...
export const Payment_Methods_List = ({ initialMethods }: Props) => {
  ...
  // ✅ New State to track which item is loading
            ...
            <div className="flex items-start gap-4 w-full sm:w-auto">
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-3">
                  ...
                  {/* Status Badge Update instantly or show loading */}
                  {togglingId === method.id ? (
                      <Badge variant="outline" className="animate-pulse bg-gray-100">Updating...</Badge>
                  ) : (
