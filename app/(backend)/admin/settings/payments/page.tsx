...
export default async function PaymentSettingsPage() {
  const { success, data: methods, error } = await getAllPaymentGateways()

  return (
    // `max-w` বাদ দেওয়া হয়েছে, এখন ফুল পেজ উইডথ (w-full) নেবে
    <div className="w-full bg-[#f0f0f1] min-h-screen pb-20 font-sans text-[13px] text-[#3c434a]">
      
      {/* Page Header (General/Product/Email বাদ দেওয়া হয়েছে) */}
