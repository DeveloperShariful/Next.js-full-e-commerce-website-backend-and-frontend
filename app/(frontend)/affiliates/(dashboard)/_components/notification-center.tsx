// File: app/(frontend)/affiliates/(dashboard)/_components/notification-center.tsx
...
import { getAnnouncements } from "@/app/actions/frontend/affiliate/_services/dashboard-service";
