// app/(frontend)/blog/_components/BlogCategoryFilter.tsx
'use client';
...
// /shop-এর ProductFilters-এর সাথে একই "professional toolbar" প্যাটার্ন —
// সাইটজুড়ে filter-এর দেখতে/আচরণ একরকম রাখার জন্য
export default function BlogCategoryFilter({ categories }: BlogCategoryFilterProps) {
  ...
  const activeCategory =
    categories.find((c) => c.slug === activeCategorySlug) || { name: 'All Posts' };
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between border-b border-gray-200 pb-5 mb-10 w-full relative z-40 px-2 md:px-0">
