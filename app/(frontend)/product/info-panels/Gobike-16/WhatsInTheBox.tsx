// app/product/info-panels/Gobike-16/WhatInTheBox.tsx

const specs = [
  { label: 'What\'s in the Box', value: '1 x GoBike 16Inch E-Bike' }, 
  { label: 'Battery Included', value: '1 x Industrial-grade waterproof 36V-42V 5.0Ah lithium-ion battery' }, 
