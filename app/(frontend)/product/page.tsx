...
import { getSingleProduct, getRelatedProducts } from "@/app/actions/frontend/product/get-single-related-product";
import { getProductReviews, getReviewStats } from "@/app/actions/frontend/product/review-actions";
import ProductBreadcrumb from "./[slug]/_components/product-breadcrumb";
import ProductDetailsTabs from "./[slug]/_components/product-details-tabs";
import RelatedProductsGrid from "./[slug]/_components/related-products-grid";
import ProductView from "./[slug]/_components/product-view";
