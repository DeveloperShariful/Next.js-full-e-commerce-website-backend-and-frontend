// File: app/admin/settings/payments/_components/Payment_Methods/Check_Payment.tsx

"use client";

import { useState } from "react";
import { updateChequeSettings } from "@/app/actions/settings/payments/cheque";
...
export default function Check_Payment({ method, onBack, refreshData }: Props) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const res = await updateChequeSettings(formData);
        if(res.success) {
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
            ...
            <div>
                ...
                <textarea 
                    ...
                    placeholder="Please send a check to Store Name..."
                />
            </div>
