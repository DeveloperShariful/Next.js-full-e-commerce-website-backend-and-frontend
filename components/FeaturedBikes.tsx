...
export default function FeaturedBikes({ products }: Props) {
  ...
  return (
    <section className="w-full pt-[12px] pb-[12px] md:pt-16 md:pb-16 bg-white">
      <div className="max-w-[1500px] mx-auto px-[5px] md:px-6">

        <div className="text-left md:text-center mb-12">
          <h2 className="text-[1.3rem] md:text-[1.6rem] font-extrabold mb-4 text-[#1a1a1a]">Explore Our Top Kids Electric Bikes</h2>
