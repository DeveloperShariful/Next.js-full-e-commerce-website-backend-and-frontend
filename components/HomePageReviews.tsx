...
export default function HomePageReviews({ initialReviews, initialSummary }: Props) {
      ...
      <div className="max-w-[1500px] mx-auto px-4">
        ...
        <div className="relative">
          <div
            ...
            ref={sliderRef}
          >
            {initialReviews.slice(0, visibleReviews).map((review) => {
        ...
        {initialReviews.length > visibleReviews && (
          <div className="text-center mt-12">
            <button
              onClick={() => setVisibleReviews(initialReviews.length)}
            ...
            >
              Show more reviews ({initialReviews.length - visibleReviews} more)
            </button>
          </div>
        )}
